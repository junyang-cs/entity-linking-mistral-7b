...
ANNOTATION_COLUMN = 'annotated_words'
RESULT_COLUMN = 'result_chunks_inst'
...
def add_annotations_to_notes(ANNOTATIONS_PATH, df_notes):
    ...
    df_notes[RESULT_COLUMN] = df_notes[ANNOTATION_COLUMN].apply(lambda x: [item + [None, None, None,None,None] for item in copy.deepcopy(x)])# copy annotations to results
